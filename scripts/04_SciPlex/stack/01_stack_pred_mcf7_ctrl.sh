...
--base-adata "data/stack/sciplex/mcf7_all.h5ad" \
--test-adata "data/stack/sciplex/a549_k562_ctrl.h5ad" \
--genelist "scripts/stack/notebooks/tutorial-pred-model/basecount_1000per_15000max.pkl" \
--split-column product_name \
--batch-size 16 \
--num-steps 5 \
--output-dir "/restricted/projectnb/agedisease/CBMrepositoryData/perturbational_data/srivatsan_2019/stack_pred/ctrl/mcf7" \
--prompt-ratio 0.25 \
--context-ratio 0.4
