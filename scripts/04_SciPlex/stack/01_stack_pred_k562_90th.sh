...
SPLIT_ARRAY=($(ls ${DATA_DIR}/k562_all_split_90th_*.h5ad | sort -V))
...
# Output directory
OUTPUT_DIR="/restricted/projectnb/agedisease/CBMrepositoryData/perturbational_data/srivatsan_2019/stack_pred/90th/${SPLIT_NAME}"
mkdir -p "${OUTPUT_DIR}"

# Extract TRUE DRUGS for this split into array
...
--test-adata "data/stack_splits/sciplex/a549_mcf7_ctrl.h5ad" \
