...
DATA_PATH <- file.path(Sys.getenv("AGED"), "CBMrepositoryData/perturbational_data/replogle_2022/rpe1_stack_pred/")
...
rpe1_sigs <- foreach(adata_filepath = adata_filepaths, .combine=dplyr::bind_rows) %dopar% {
...
saveRDS(rpe1_sigs, file.path(SAVE_PATH, "rpe1_sigs.rds"))
